from parkour_tasks.extreme_parkour_task.config.b2.agents.parkour_rl_cfg import (
...
@configclass
class UnitreeB2ParkourTeacherPPORunnerCfg(ParkourRslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 50000
    save_interval = 100
    experiment_name = "unitree_b2_parkour"
